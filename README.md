...
### Nutricionista | Designer | Desenvolvedor

Sou um profissional que acredita na intersecção entre saúde e tecnologia. Atuo como **Nutricionista** e utilizo meus conhecimentos em **Programação** e **Design** para otimizar processos, automatizar tarefas e criar soluções digitais que tragam valor real para a área da nutrição.
